...
\resizebox{10cm}{!}{
                  \begin{tabular}{| l | l | l | l |}
                    ...
                    Supported Platforms     &  Linux, OS X and Win (partial) & Linux, Win, OS X & Linux, OS X   \\  \hline  
                  \end{tabular}
}
...
\begin{frame}{Putting Them Together}
	\begin{center}
	  \movie[showcontrols=false]{\includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{videos/lane_following_all.png}}{videos/lane_following_all.mp4}
	\end{center}
\end{frame}
